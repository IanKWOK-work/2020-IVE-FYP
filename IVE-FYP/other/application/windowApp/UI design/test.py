...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphicsView_4 = QtSvg.QSvgWidget('img/attitude_roll_2.svg')
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 848, 370))
